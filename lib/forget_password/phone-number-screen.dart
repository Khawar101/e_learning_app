...
class _SignInPhoneScreenState extends State<SignInPhoneScreen> {
  ...
  Padding(
          ...
          Padding(
            ...
            child: const Text('A handful of model sentence structure',
          ...
          const Padding(
            ...
            //  controller: phoneController,
              ...
              border: OutlineInputBorder(
                borderSide: BorderSide(color: Color(0xff3787ff), width: 2.0),
          ...
          SizedBox(  height: MediaQuery.of(context).size.height*0.02, ),
            ...
            child:RichText(
              textAlign: TextAlign.center,
            text:  TextSpan(
              text: 'We Sent a',style: GoogleFonts.ibmPlexSans(color: Colors.black,),             
              children:const [
                 TextSpan(text: ' Verification code ', style:TextStyle(color: Colors.blue),),
